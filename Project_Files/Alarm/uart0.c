...
void UART0_Init(void)
{
	...
	UART0->BDH = 1;			//Dla CLOCK_SETUP=0 BR=28800	BDH=0 BR=9600	BDH=1
	UART0->BDL =17;			//Dla CLOCK_SETUP=0 BR=28800	BDL=91 BR=9600	BDL=17	:	CLOCK_SETUP=1	BR=230400		BDL=13
